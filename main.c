...
main ()
{
  ...
  closure_t func =
    closure_make (sum, 10, 2, CLOSURE_SCALAR (9), CLOSURE_SCALAR (1));
  ...
  closure_t func = closure_make (fix_sum, 2, 1, CLOSURE_SCALAR (1));
  intptr_t res = func (2);
  ...
  closure_t func = closure_make (fix_sum_char, 2, 1, CLOSURE_SCALAR (2));
  intptr_t res = func (2);
